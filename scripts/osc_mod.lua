...
--[[
    mpv_thumbnail_script.lua 0.4.2 fork - follow the official mpv commit 152b0e2
    Original https://github.com/TheAMM/mpv_thumbnail_script   https://github.com/mpv-player/mpv/blob/master/player/lua/osc.lua
    Update 20200520
]]--
